...
const DownloadButton = () => {
    ...
    return (
        <>
            <div ref={printRef} className="absolute -left-[999px] mx-auto bg-white shadow-lg text-text rounded-md p-4">
                ...
                <div className="grid grid-cols-3 gap-2 bg-gray-100 p-2 uppercase rounded-md text-sm">
                    <div className="bg-bluebg h-20 flex flex-col justify-between py-4 p-2 text-sm rounded-lg">
                        ...
                        <p className="font-semibold text-sm">C&M TRAVEL & TOURISM(PVT)LTD</p>
                    </div>
                    <div className="bg-bluebg h-20 flex flex-col justify-between py-4 p-2 text-sm rounded-lg">
                ...
                <div className=" border-gray p-3 py-5">
                    ...
                    <div className="flex gap-3 items-center text-sm text-gray p-2 mt-3 bg-bluebg border-l-4 border-primary font-semibold ">
                        <p className="flex items-center gap-3"><BsFillSuitcaseFill className="text-text text-lg" />Baggage Allowance: Total 20.0 KG (As per airline policy) </p>
                        <p className="flex items-center gap-3 border-l border-r border-lightgray px-4"> <GiMeal className="text-text text-xl" /> Meal Included </p>
                        <p>ECONOMY</p>
                    </div>
            ...
            <button className="p-2 rounded-full hover:bg-slate-200 bg-bluebg border border-primary text-primary " onClick={handleDownloadPdf}>
