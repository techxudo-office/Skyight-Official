...
export default function Modal({ imgsrc, Message, title, onBtnClick, btnText, active,toggle }) {
    ...
    return (
       Show&&active && 
            ...
            {toggle&&<MdCancel className='absolute bg-white rounded-full  text-2xl  top-10 right-4 md:right-10 text-redColor cursor-pointer' onClick={()=>setShow(false)}/>}

                <div className="bg-blue-100 py-5 rounded-2xl shadow-xlw-full max-w-md border-2 border-primary">
                    {/* Logo */}
