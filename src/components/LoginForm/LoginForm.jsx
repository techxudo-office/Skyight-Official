...
const LoginForm = () => {
  ...
  return (
    <>
      {!registerModal && (
        <CardLayoutContainer className="max-w-[900px]  mx-auto mt-20  overflow-y-scroll">
          <CardLayoutBody removeBorder padding="p-0" className="flex bg-white">
            ...
            <div className="flex-1 p-16 rounded-r-lg register-component-bg">
              <h3 className="mb-10 text-4xl font-extrabold text-center">
                Registration
              </h3>
      ...
      {registerModal && (
        <CardLayoutContainer className="max-w-[900px] mt-[1000px]  bg-white  mx-auto my-auto  pb-20 ">
          <div
            ...
            className="flex items-center justify-start w-full pt-8 pl-8 text-2xl cursor-pointer text-text"
          >
            <MdArrowBack />
          </div>
          <RegistrationForm />
