...

                {
                  ...
                  link.sublinks.map((sublink, sublinkIndex) => (
                    <li
                      ...
                      className={` w-full flex items-center gap-2 px-5 cursor-pointer transition-all ${activeMenu === linkIndex &&
                          activeSubmenu === sublinkIndex
                          ? "text-primary"
                          : "text-slate-400"
                        } ${activeMenu === linkIndex &&
                          link.sublinks ?'h-auto py-1':'h-0 overflow-hidden opacity-0'} hover:text-primary rounded-full text-sm font-semibold transition-all duration-300`}
                    >
